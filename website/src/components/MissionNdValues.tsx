        ...
        <Box pb={10} px={0}>
            {/* <Stack spacing={4} as={Container} maxW={'3xl'} textAlign={'center'} py={4} mb={10}>
                ...
                <Text color={'gray.600'} fontSize={{ base: 'sm', sm: 'lg' }}>
                    Reasons why Hyperloop is a necessity
                </Text>
            </Stack> */}
            ...
            {/* <Flex flexWrap="wrap" gridGap={10} justify="center">
                    ...
                    >
                        <Heading size="md">{'REDUCED CARBON EMISSIONS'}</Heading>
                    </Box>
                    <Box
                        maxW={{ base: 'full', md: '400px' }}
                        w={'full'}
                        ...
                        textAlign={'center'}
                    >
                        <Heading size="md">{'REDUCED TRAVEL TIME'}</Heading>
                    </Box>
                    <Box
                        maxW={{ base: 'full', md: '400px' }}
                        w={'full'}
                        ...
                        textAlign={'center'}
                    >
                        <Heading size="md">{'NATURAL DISASTER RESILIENT'}</Heading>
                    </Box>
                    <Box
                        maxW={{ base: 'full', md: '400px' }}
                        w={'full'}
            ...
            <Box bg={useColorModeValue('white', 'gray.800')} w={'full'} px={0} py={10}>
                <Stack spacing={4} as={Container} maxW={'5xl'} textAlign={'center'} py={4} mb={10} id='what-is-hyperloop'>
                    <Stack spacing={4} as={Container} maxW={'3xl'} textAlign={'center'} py={6}>
                        <Heading
            ...
            <Container maxW={'5xl'} py={16}>
                <Box textAlign={'center'} mb={10}>
                    <Heading as={'span'}
                        ...
                        bgClip="text" fontSize={{ base: '2xl', sm: '5xl' }} fontWeight={'bold'} >
                        Why GHC?
                    </Heading>
                </Box>
                <SimpleGrid columns={{ base: 1, md: 2 }} spacing={12}>
                    ...
                    <VStack spacing={6}>
                        ...
                        <Text color={'gray.500'} fontSize={'lg'}>
                            The Global Hyperloop Competition will essentially serve as a platform for forging innovation among the teams around the world  to bring out a plethora of caricature to realise a new mode of transportation - Hyperloop. This is not only a competition, but a pedestal for the world to come together and re-engineer mobility.
                        </Text>
                    </VStack>
                </SimpleGrid>
            </Container>
            ...
            <Container maxW={'5xl'} my={12}>
                <Flex flexWrap="wrap" gridGap={6} justify="center">
                    <Card
                        ...
                        description={'By explaining the hyperloop technologies and its associated benefits - incredible speed, safety and sustainability - to people, GHC will ensure the development of a massive Hyperloop community over the years to revolutionalise the existing transport system.'}
                        href={'#'}
                    />
                    <Card
                    ...
                    <Card
                        ...
                        description={'Engaging students and teams to ideate, innovate and develop is the goal of the Competition. The competitive spirit will drive teams to unleash their best innovative spirits to showcase the different perspectives on the hyperloop technology and assist its growth.'}
                        href={'#'}
                    />
                </Flex>
            </Container>
